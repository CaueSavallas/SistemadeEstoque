...
if menu == "Inserir Produto":
    ...
    if st.button("Salvar"):
        if nome:
            ...
            st.warnig("Nome do produto é obrigatorio.")
    ...
    dados = atualizar_produto(1, "Arroz", "Alimento", 10.50, 20, "Fornecedor A")
